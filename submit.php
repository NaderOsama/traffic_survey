...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    gender, age, education,experience_street,driving_license, `private_car`, `bus`, `microbus`, `taxi`,motorcycle, train, road_usage6amTo9am, road_usage9amTo12am, road_usage12amTo3pm, road_usage3pmTo5pm, road_usage5pmTo8pm, road_usage8pmTo11pm, 
    ...
    traffic_median_signals, traffic_median_no_signals, roundabouts, around_commercial_areas, areas_with_street_vendors, bridge_interchanges, example_type_1_location, `long`, lat, example_type_1_timing, example_type_1_day,
    

    behavioral_and_cultural_reasons,road_engineering_and_planning,traffic_management_reasons,reasons_of_mass_transit,reasons_of_pedestrian_and_bicycle,reasons_of_legislation_and_laws,

    wrong_car_parking,random_bus_stop,random_crossing_of_the_road,excessive_passenger_car_exit,low_bicycle_usage_lack_of_pedestrian,
    
    insufficient_road_or_tunnel_width,poor_bridge_interchanges_design,excessive_roundabouts,poor_bridge_design_for_pedestrians,insufficient_parking_around_commercial_areas,

    insufficient_traffic_lights,bus_and_microbus_stops_in_riverway,lack_of_bicycle_lanes,non_compliance_with_traffic_signs_specifications,poor_official_public_transport_service_level,commercial_entities_using_sidewalks,

    insufficient_taxi_pickup_and_drop_off_areas,concentration_of_government_and_private_entities_work,insufficient_alternatives_for_urban_transportation,lack_of_appropriate_pedestrian_crossings,difficulty_using_pedestrian_crossings,  

    lack_of_separation_between_traffic_and_pedestrian_paths,inappropriateness_of_public_transportation,unavailability_of_public_transportation,lack_of_integration_of_public_transportation,high_cost_of_public_transportation,lack_of_scheduled_timings,

    driver_ill_treatment,lack_of_air_conditioning,unwillingness_to_walk_long_distances,fear_and_lack_of_safety,Government_and_private_offices_and_services,Working_hours_for_both_government_and_private,



    random_microbus_stop,
    random_taxi_stop, 
    random_private_car_stop,
    disregard_traffic_signals,
    
    lack_of_road_awareness,
    

    
    poor_service_or_condition,   unavailability_of_transportation_to_destination, proposal_1, proposal_2, proposal_3,
    ...
    '$gender', '$age', '$education','$experience_street','$drivingLicense', '$selectedPrivateCar', '$bus', '$microbus', '$taxi','$motorcycle','$train', '$road_usage6amTo9am', '$road_usage9amTo12am', '$road_usage12amTo3pm', '$road_usage3pmTo5pm', '$road_usage5pmTo8pm', '$road_usage8pmTo11pm',
    '$cairo_usage6amTo9am', '$cairo_usage9amTo12am', '$cairo_usage12amTo3pm', '$cairo_usage3pmTo5pm', '$cairo_usage5pmTo8pm', '$cairo_usage8pmTo11pm',
    '$traffic_median_signals', '$traffic_median_no_signals', '$roundabouts', '$around_commercial_areas', '$areas_with_street_vendors', '$bridge_interchanges', '$exampleType1Location', '$long', '$lat', '$exampleType1Timing','$exampleType1Day', 
